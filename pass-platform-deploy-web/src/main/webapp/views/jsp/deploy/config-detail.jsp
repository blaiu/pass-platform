		...
		<div class="template-page-wrapper">
			...
			<div class="templatemo-content-wrapper">
				<div class="templatemo-content">
					...
					<div class="row">
						<div class="col-md-12">
							<form action="${ctx}/deploy/modify" method="post" id="projectForm">
								<div class="row">
									<div class="col-md-12 margin-bottom-15">
										<label for="configName" class="control-label">配置名称</label>
										<input type="text" class="form-control" id="configName" name="configName" value="${view.configName}" required maxlength=20> 
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 margin-bottom-15">
										<label for="memory" class="control-label">内存(M)</label> 
										<input type="text" class="form-control" id="memory" name="memory" value="${view.memory}" required min=0 max=8192>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12 margin-bottom-15">
										...
										<input type="text" class="form-control" id="cpu" name="cpu" value="${view.cpu}" required min=0 max=8192>
									</div>
								</div>
